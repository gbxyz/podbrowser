...
Requires:	gtk2 >= 2.8.0, libglade2, gnome-icon-theme > 2.10, gettext, perl >= 5.8.0, perl-URI, perl-Gtk2, perl-Gtk2-GladeXML >= 1.001, perl-gettext, perl-Gtk2-Ex-PodViewer >= 0.14, perl-Pod-Simple, perl-Gtk2-Ex-Simple-List, perl-Text-Levenshtein
